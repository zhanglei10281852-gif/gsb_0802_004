...
export interface CoverageGap {
  ...
  verdict: "compatible" | "incompatible" | "error" | null;
  details: string | null;
...
export const api = {
  ...
  exemptions: (candidateHash?: string) =>
    jsonRequest<{ exemptions: Exemption[] }>(
      candidateHash
        ? `/api/exemptions?candidateHash=${encodeURIComponent(candidateHash)}`
        : "/api/exemptions",
    ),
  ...
  causalEvents: () =>
    jsonRequest<{ events: CausalEvent[] }>("/api/causal-events"),
  startRollout: (
    proposalId: string,
  ...
  reportReceipt: (
    ...
    jsonRequest<{ receipt: unknown; rollout: Rollout; duplicate: boolean }>(
  ...
  resumeRollout: (rolloutId: string) =>
    jsonRequest<{ rollout: Rollout }>(`/api/rollouts/${rolloutId}/resume`, {
      method: "POST",
    }),
  ...
  verifyCoverageGap: (
    ...
    jsonRequest<{ gap: CoverageGap; rollout: Rollout; duplicate: boolean }>(
